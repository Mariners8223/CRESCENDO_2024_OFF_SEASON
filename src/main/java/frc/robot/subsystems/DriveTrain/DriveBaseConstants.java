...
public class DriveBaseConstants {
        public static final class PathPlanner{
            ...
            public static final PIDFGains THETA_PID = new PIDFGains(1.5, 0, 0); //the pid gains for the PID Controller of the robot angle, units are radians per second
            public static final PIDFGains XY_PID = new PIDFGains(6, 0, 0.2); //the pid gains for the pid controller of the robot's velocity, units are meters per second
        }
