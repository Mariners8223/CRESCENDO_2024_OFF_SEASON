...
public class MotorMap {
    public static class DriveBase{
        public static class Front_Left{
            ...
            public static int absEncoder = Constants.robotType == RobotType.DEVELOPMENT ? 10 : 10;
        }
        ...
        public static class Front_Right{
            ...
            public static int absEncoder = Constants.robotType == RobotType.DEVELOPMENT ? 11 : 11;
        }
        ...
        public static class Back_Left{
            ...
            public static int absEncoder = Constants.robotType == RobotType.DEVELOPMENT ? 12 : 12;
        }
        ...
        public static class Back_Right{
            ...
            public static int absEncoder = Constants.robotType == RobotType.DEVELOPMENT ? 13 : 12;
        }
    }
}
