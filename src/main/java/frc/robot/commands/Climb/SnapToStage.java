...
public class SnapToStage extends Command {
  Climb climb;
  ...
  double x;
  double y; 
  /** Creates a new SnapToStage. */
  public SnapToStage(Climb climb, Supplier<Pose2d> poseSupply, Supplier<Rotation2d> angleSupply, Consumer<Optional<Rotation2d>> angleConsumer) {
